...
(async () => {
  ...
  console.log('登录状态:', loginStatus.status_code, loginStatus.status_msg || '');
  console.log('当前URL:', page.url());
  
  if (loginStatus.status_code !== 0) {
    console.log('❌ 未登录！Cookies可能已过期');
    await browser.close();
    return;
  }
  ...
  await page.screenshot({ path: '/home/z/my-project/debug2.png' });
  await browser.close();
})();
