...
def webhook():
    ...
    # 用 force=True 忽略 Content-Type 强制按 JSON 解析，防止飞书验证请求返回 415
    ...
    if body is None:
        ...
        try:
            ...
            logger.warning(f"Failed to parse webhook body: {raw[:200]}")
...
def webhook_verify():
    """Handle Feishu URL verification GET requests"""
